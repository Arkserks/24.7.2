...
def test_get_empty_list_of_my_pets_after_delete_all_with_valid_key(filter="my_pets"):
    ...
    приходит пустой список 'pets'/ Так же проверяем полное удаление всех своих питомцев питомцев"""
    ...
    # Если список не пуст, запускаем цикл, где удаляем первого питомца в нашем списке
    ...
    if len(my_pets['pets']) == 0:
        ...
        # Получаем список своих питомцев своих питомцев
        status, result = pf.get_list_of_pets(auth_key, filter)
...
def test_add_new_pet(name=name1, animal_type=animal_type1, age=age1, pet_photo=pet_photo1):
    """Проверяем возвожномть создания питомца с фотографией"""
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Суперкот", "кот", "3", "images/image3.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Магдалена', animal_type='Собака', age=40):
...
def test_successful_add_photo_of_pet(pet_photo=pet_photo2):
    """Проверяем возможность добавления фотографии уже существующему питомцу"""
...
def test_create_pet_simple_with_49_simbols_name(name=name49, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 49 символов"""
...
def test_create_pet_simple_with_50_simbols_name(name=name50, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 50 символов"""
...
def test_create_pet_simple_with_51_simbols_name(name=name51, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 51 символ"""
...
def test_create_pet_simple_with_99_simbols_name(name=name99, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 99 символов"""
...
def test_create_pet_simple_with_100_simbols_name(name=name100, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 100 символов"""
...
def test_create_pet_simple_with_101_simbols_name(name=name101, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c именем в 101 символ"""
...
def test_create_pet_simple_with_empty_name(name=name_empty, animal_type=animal_type2, age=age2):
    """Проверяем возвожномть создания питомца без фотографии c пустым именем. Тут есть момент что бек пропускает
